...
do iv_emit = 2,14 ! test = 1, Nebula = 2 - 14 , QSO = 12-14
...
basename = 'WOCIVL440M0001NH220'
call initialize_data('WOCIVL455M1NH220.txt') ! 내가 추가한 term + 변경해야할 곳
call set_escape_observer()
call set_dust('dust_data/MW_C_IV.dat')
	write(fn_model,100) 'WOCIVL455M1NH220/N_atom',N_atom(iN_atom), &
