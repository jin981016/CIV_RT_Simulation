...
public gen_photon_cloudy_Nebula
public gen_photon_cloudy_QSO
...
subroutine gen_photon_cloudy_Nebula(photon, v_emit)
use random
use data_mod
use interpolate
implicit none
...
! Function_find_y_interpolate

end subroutine gen_photon_cloudy_Nebula



subroutine gen_photon_cloudy_QSO(photon, v_emit)
use random
use data_mod
use interpolate
implicit none
...
call initial_photon(photon)
end subroutine gen_photon_cloudy_QSO
